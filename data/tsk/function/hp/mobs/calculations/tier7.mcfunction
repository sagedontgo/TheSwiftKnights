...
scoreboard players operation $temp.tier7.mobLevel tsk.calcNewHp = @s tsk.mobLevel

execute store result score $tier7.temp.lvl tsk.calcNewHp run scoreboard players operation $temp.tier7.mobLevel tsk.calcNewHp *= $10000 tsk.int
...
execute store result score $tier7.temp.lvl tsk.calcNewHp run scoreboard players operation $temp.tier7.mobLevel tsk.calcNewHp /= $2 tsk.int

execute store result score $tier7.temp.z tsk.calcNewHp run scoreboard players operation $tier7.temp.z tsk.calcNewHp += $tier7.temp.lvl tsk.calcNewHp
...
scoreboard players reset $temp.tier7.mobLevel tsk.calcNewHp
scoreboard players reset $temp.worldLevel tsk.calcNewHp
scoreboard players reset $tier7.temp.lvl tsk.calcNewHp
