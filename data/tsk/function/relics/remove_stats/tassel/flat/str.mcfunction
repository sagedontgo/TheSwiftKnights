...
tag @s remove tsk.relicBuff.flat.tassel.str
scoreboard players operation @s tsk.str -= @s tsk.relicBuff.tassel.str
tellraw @s [{"text":"The tassel stops moving... you lose","color": "gray","extra": [{"text":" -","color":"red"}]},{"score":{"name": "@s","objective": "tsk.relicBuff.tassel.str"},"color": "red"},{"text":" Attack Strength","color": "red"}]
