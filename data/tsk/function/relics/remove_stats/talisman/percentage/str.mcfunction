...
tag @s remove tsk.relicBuff.percentage.talisman.str
scoreboard players operation @s tsk.str -= @s tsk.relicBuff.talisman.str
tellraw @s [{"text":"The talisman falls silent... you lose","color": "gray","extra": [{"text":" -","color":"red"}]},{"score":{"name": "@s","objective": "tsk.relicBuff.talisman.str"},"color": "red"},{"text":" Maximum HP","color": "red"}]
