...
execute if score $tsk.level tsk.relic.level matches 2 at @s run function tsk:relics/upgrade/modify_stats/lore/sub_stats/lvl2/flat/mana_max with storage tsk:storage statBuff
execute if score $tsk.level tsk.relic.level matches 4 at @s run function tsk:relics/upgrade/modify_stats/lore/sub_stats/lvl4/flat/mana_max with storage tsk:storage statBuff
execute if score $tsk.level tsk.relic.level matches 6 at @s run function tsk:relics/upgrade/modify_stats/lore/sub_stats/lvl6/flat/mana_max with storage tsk:storage statBuff
execute if score $tsk.level tsk.relic.level matches 8 at @s run function tsk:relics/upgrade/modify_stats/lore/sub_stats/lvl8/flat/mana_max with storage tsk:storage statBuff
