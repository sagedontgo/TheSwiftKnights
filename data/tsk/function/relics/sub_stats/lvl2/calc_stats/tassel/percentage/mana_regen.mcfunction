...
tag @s add tsk.relicBuff.substat1.percentage.tassel.manaRegen
...
scoreboard players operation @s tsk.relicBuff.substat1.tassel.manaRegen += $temp.manaRegen tsk.getPercentageOf
