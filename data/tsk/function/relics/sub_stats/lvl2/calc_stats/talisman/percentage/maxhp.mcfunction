...
tag @s add tsk.relicBuff.substat1.percentage.talisman.maxHp
...
scoreboard players operation @s tsk.relicBuff.substat1.talisman.maxHp += $temp.maxHp tsk.getPercentageOf
scoreboard players operation @s tsk.maxHp += @s tsk.relicBuff.substat1.talisman.maxHp 
 
tellraw @s [{"text": "","color": "gray","extra": [{"text":" +","color":"green"}]},{"score":{"name": "@s","objective": "tsk.relicBuff.substat1.talisman.maxHp"},"color": "green"},{"text":" MAX HP","color": "green"}]
