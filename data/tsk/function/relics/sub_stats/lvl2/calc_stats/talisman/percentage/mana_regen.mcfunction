...
tag @s add tsk.relicBuff.substat1.percentage.talisman.manaRegen
...
scoreboard players operation @s tsk.relicBuff.substat1.talisman.manaRegen += $temp.manaRegen tsk.getPercentageOf
scoreboard players operation @s tsk.manaRegenRate += @s tsk.relicBuff.substat1.talisman.manaRegen
 
tellraw @s [{"text": "","color": "gray","extra": [{"text":" +","color":"green"}]},{"score":{"name": "@s","objective": "tsk.relicBuff.substat1.talisman.manaRegen"},"color": "green"},{"text":" Mana Regeneration Rate","color": "green"}]
