...
tag @s add tsk.relicBuff.substat1.percentage.talisman.maxMana
...
scoreboard players operation @s tsk.relicBuff.substat1.talisman.maxMana += $temp.maxMana tsk.getPercentageOf
scoreboard players operation @s tsk.manaMax += @s tsk.relicBuff.substat1.talisman.maxMana
 
tellraw @s [{"text":"T ","color": "gray","extra": [{"text":" +","color":"green"}]},{"score":{"name": "@s","objective": "tsk.relicBuff.substat1.talisman.maxMana"},"color": "green"},{"text":" Maximum Mana","color": "green"}]
