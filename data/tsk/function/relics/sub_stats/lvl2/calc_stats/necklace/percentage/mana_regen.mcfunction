...
tag @s add tsk.relicBuff.substat1.percentage.necklace.manaRegen
...
scoreboard players operation @s tsk.relicBuff.substat1.necklace.manaRegen += $temp.manaRegen tsk.getPercentageOf
