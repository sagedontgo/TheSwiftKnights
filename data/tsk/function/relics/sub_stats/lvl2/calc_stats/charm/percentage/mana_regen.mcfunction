...
tag @s add tsk.relicBuff.substat1.percentage.charm.manaRegen
...
scoreboard players operation @s tsk.relicBuff.substat1.charm.manaRegen += $temp.manaRegen tsk.getPercentageOf
