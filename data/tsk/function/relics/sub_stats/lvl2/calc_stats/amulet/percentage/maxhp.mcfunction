...
tag @s add tsk.relicBuff.substat1.percentage.amulet.maxHp
...
scoreboard players operation @s tsk.relicBuff.substat1.amulet.maxHp += $temp.maxHp tsk.getPercentageOf
scoreboard players operation @s tsk.maxHp += @s tsk.relicBuff.substat1.amulet.maxHp 
 
tellraw @s [{"text": "","color": "gray","extra": [{"text":" +","color":"green"}]},{"score":{"name": "@s","objective": "tsk.relicBuff.substat1.amulet.maxHp"},"color": "green"},{"text":" MAX HP","color": "green"}]
