...
tag @s add tsk.relicBuff.substat1.percentage.amulet.maxMana
...
scoreboard players operation @s tsk.relicBuff.substat1.amulet.maxMana += $temp.maxMana tsk.getPercentageOf
scoreboard players operation @s tsk.manaMax += @s tsk.relicBuff.substat1.amulet.maxMana
 
tellraw @s [{"text":"T ","color": "gray","extra": [{"text":" +","color":"green"}]},{"score":{"name": "@s","objective": "tsk.relicBuff.substat1.amulet.maxMana"},"color": "green"},{"text":" Maximum Mana","color": "green"}]
