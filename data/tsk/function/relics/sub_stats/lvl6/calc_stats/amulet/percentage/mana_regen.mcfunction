...
tag @s add tsk.relicBuff.substat3.percentage.amulet.manaRegen
...
scoreboard players operation @s tsk.relicBuff.substat3.amulet.manaRegen += $temp.manaRegen tsk.getPercentageOf
