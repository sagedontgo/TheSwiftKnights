...
tag @s add tsk.relicBuff.substat3.percentage.charm.def
...
# Ex: tsk.relicTemp.sub3 = 24; tsk.percentageValue.$tsk.percentageValue = 24
...
scoreboard players operation @s tsk.relicBuff.substat3.charm.def += $temp.def tsk.getPercentageOf
