...
tag @s add tsk.relicBuff.substat3.percentage.charm.maxMana
...
scoreboard players operation @s tsk.relicBuff.substat3.charm.maxMana += $temp.maxMana tsk.getPercentageOf
scoreboard players operation @s tsk.manaMax += @s tsk.relicBuff.substat3.charm.maxMana
 
tellraw @s [{"text":"T ","color": "gray","extra": [{"text":" +","color":"green"}]},{"score":{"name": "@s","objective": "tsk.relicBuff.substat3.charm.maxMana"},"color": "green"},{"text":" Maximum Mana","color": "green"}]
