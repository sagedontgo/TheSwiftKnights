...
tag @s add tsk.relicBuff.substat3.percentage.charm.manaRegen
...
scoreboard players operation @s tsk.relicBuff.substat3.charm.manaRegen += $temp.manaRegen tsk.getPercentageOf
