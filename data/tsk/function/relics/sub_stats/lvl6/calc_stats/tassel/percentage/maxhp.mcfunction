...
tag @s add tsk.relicBuff.substat3.percentage.tassel.maxHp
...
scoreboard players operation @s tsk.relicBuff.substat3.tassel.maxHp += $temp.maxHp tsk.getPercentageOf
scoreboard players operation @s tsk.maxHp += @s tsk.relicBuff.substat3.tassel.maxHp 
 
tellraw @s [{"text": "","color": "gray","extra": [{"text":" +","color":"green"}]},{"score":{"name": "@s","objective": "tsk.relicBuff.substat3.tassel.maxHp"},"color": "green"},{"text":" MAX HP","color": "green"}]
