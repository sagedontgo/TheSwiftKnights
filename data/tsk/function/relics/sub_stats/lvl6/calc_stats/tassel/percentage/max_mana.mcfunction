...
tag @s add tsk.relicBuff.substat3.percentage.tassel.maxMana
...
scoreboard players operation @s tsk.relicBuff.substat3.tassel.maxMana += $temp.maxMana tsk.getPercentageOf
scoreboard players operation @s tsk.manaMax += @s tsk.relicBuff.substat3.tassel.maxMana
 
tellraw @s [{"text":"T ","color": "gray","extra": [{"text":" +","color":"green"}]},{"score":{"name": "@s","objective": "tsk.relicBuff.substat3.tassel.maxMana"},"color": "green"},{"text":" Maximum Mana","color": "green"}]
