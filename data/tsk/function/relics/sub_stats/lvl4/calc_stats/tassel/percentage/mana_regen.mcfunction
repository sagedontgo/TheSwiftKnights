...
tag @s add tsk.relicBuff.substat2.percentage.tassel.manaRegen
...
scoreboard players operation @s tsk.relicBuff.substat2.tassel.manaRegen += $temp.manaRegen tsk.getPercentageOf
