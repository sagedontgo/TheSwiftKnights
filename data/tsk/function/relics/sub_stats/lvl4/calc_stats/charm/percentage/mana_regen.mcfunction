...
tag @s add tsk.relicBuff.substat2.percentage.charm.manaRegen
...
scoreboard players operation @s tsk.relicBuff.substat2.charm.manaRegen += $temp.manaRegen tsk.getPercentageOf
