...
tag @s add tsk.relicBuff.substat2.percentage.charm.def
...
# Ex: tsk.relicTemp.sub2 = 24; tsk.percentageValue.$tsk.percentageValue = 24
...
scoreboard players operation @s tsk.relicBuff.substat2.charm.def += $temp.def tsk.getPercentageOf
