...
tag @s add tsk.relicBuff.substat2.percentage.amulet.manaRegen
...
scoreboard players operation @s tsk.relicBuff.substat2.amulet.manaRegen += $temp.manaRegen tsk.getPercentageOf
