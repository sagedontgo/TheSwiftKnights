...
tag @s add tsk.relicBuff.substat4.percentage.amulet.manaRegen
...
scoreboard players operation @s tsk.relicBuff.substat4.amulet.manaRegen += $temp.manaRegen tsk.getPercentageOf
