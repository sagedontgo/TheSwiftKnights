...
tag @s add tsk.relicBuff.substat4.percentage.amulet.critRate
...
scoreboard players operation @s tsk.relicBuff.substat4.amulet.critRate += $temp.critRate tsk.getPercentageOf
scoreboard players operation @s tsk.critRate += @s tsk.relicBuff.substat4.amulet.critRate
 
tellraw @s [{"text": "","color": "gray","extra": [{"text":" +","color":"green"}]},{"score":{"name": "@s","objective": "tsk.relicBuff.substat4.amulet.critRate"},"color": "green"},{"text":" Crit Rate","color": "green"}]
