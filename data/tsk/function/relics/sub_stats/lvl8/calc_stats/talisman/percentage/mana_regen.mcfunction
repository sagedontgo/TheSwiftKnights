...
tag @s add tsk.relicBuff.substat4.percentage.talisman.manaRegen
...
scoreboard players operation @s tsk.relicBuff.substat4.talisman.manaRegen += $temp.manaRegen tsk.getPercentageOf
