...
tag @s add tsk.relicBuff.substat4.percentage.necklace.maxMana
...
scoreboard players operation @s tsk.relicBuff.substat4.necklace.maxMana += $temp.maxMana tsk.getPercentageOf
scoreboard players operation @s tsk.manaMax += @s tsk.relicBuff.substat4.necklace.maxMana
 
tellraw @s [{"text":"T ","color": "gray","extra": [{"text":" +","color":"green"}]},{"score":{"name": "@s","objective": "tsk.relicBuff.substat4.necklace.maxMana"},"color": "green"},{"text":" Maximum Mana","color": "green"}]
