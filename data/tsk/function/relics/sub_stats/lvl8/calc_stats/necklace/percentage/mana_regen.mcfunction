...
tag @s add tsk.relicBuff.substat4.percentage.necklace.manaRegen
...
scoreboard players operation @s tsk.relicBuff.substat4.necklace.manaRegen += $temp.manaRegen tsk.getPercentageOf
