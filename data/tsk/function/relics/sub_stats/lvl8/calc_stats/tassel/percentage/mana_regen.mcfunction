...
tag @s add tsk.relicBuff.substat4.percentage.tassel.manaRegen
...
scoreboard players operation @s tsk.relicBuff.substat4.tassel.manaRegen += $temp.manaRegen tsk.getPercentageOf
