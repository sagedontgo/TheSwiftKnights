...
tag @s add tsk.relicBuff.percentage.talisman.maxHp
...
scoreboard players operation @s tsk.relicBuff.talisman.maxHp = $temp.maxHp tsk.getPercentageOf
...
tellraw @s [{"text":"The talisman hums with energy... it empowers you with","color": "gray","extra": [{"text":" +","color":"green"}]},{"score":{"name": "@s","objective": "tsk.relicBuff.talisman.maxHp"},"color": "green"},{"text":" MAX HP","color": "green"}]
