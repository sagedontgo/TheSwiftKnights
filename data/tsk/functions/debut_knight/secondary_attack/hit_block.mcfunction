...
summon area_effect_cloud ~ ~ ~ {Particle:"block snow_block",ReapplicationDelay:20,Radius:1f,RadiusPerTick:0.1f,Duration:100,Effects:[{Id:2,Amplifier:3b,Duration:100,ShowParticles:1b},{Id:15,Amplifier:3b,Duration:100,ShowParticles:1b},{Id:20,Amplifier:3b,Duration:100}]}
execute as @e[type=#tsk:attackable,distance=..14] at @s run damage @s 5 tsk:debut_knight/secondary_attack
